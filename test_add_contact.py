...
from contact import Contact_main_info
...
class test_add_contact(unittest.TestCase):
    ...
    def add_contact(self, wd, firstname, middlename, lastname, nick, title, cname, address, homedid, cellular, workdid,
                    email, email2, email3, website, address2, home, notes):
        ...
        wd.find_element_by_name("company").send_keys(cname)
        ...
        wd.find_element_by_name("home").send_keys(homedid)
        wd.find_element_by_name("mobile").click()
        wd.find_element_by_name("mobile").clear()
        wd.find_element_by_name("mobile").send_keys(cellular)
        wd.find_element_by_name("work").click()
        wd.find_element_by_name("work").clear()
        wd.find_element_by_name("work").send_keys(workdid)
        ...
        wd.find_element_by_name("homepage").send_keys(website)
    ...
    def test_add_contact(self):
        ...
        self.add_contact(wd, firstname="qwerty", middlename="aaaaaaaa", lastname="eeeeeeeeee", nick="rrrrrrrrr", title="aaaaaaaaa", cname="ssssssssss", address="dddddddddddd",
                         homedid="fffffffff", cellular="gggggggggg", workdid="hhhhhhhhh", email="ppppppp", email2="ooooooo", email3="iiiiiiiiiiii", website="ffffffffffff",
                         address2="ssssssssssssssssssssssssssssssssssssssssssss", home="555444333", notes="fffffffffffffffffffffffffffffffffffffffffff")
